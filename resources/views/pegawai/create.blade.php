                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('pegawai.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama" class="block w-full mt-1" type="text" name="nama" :value="old('nama')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="alamat" name="alamat" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('alamat') }}</textarea>
                            <x-input-error :messages="$errors->get('alamat')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="tanggal_lahir" :value="__('Tanggal Lahir')" />
                            <x-text-input id="tanggal_lahir" class="block w-full mt-1" type="date" name="tanggal_lahir" :value="old('tanggal_lahir')" required />
